...
def get_tweets(query, pages=25, include_rts=True):
    ...
    def gen_tweets(pages, include_rts):
        ...
        while pages > 0:
            ...
            for tweet in html.find('.stream-item'):
                ...
                if (include_rts == False and is_retweet == True):
                    pass
                else:
                    tweets.append({
                        'tweetId': tweet_id,
    ...
    yield from gen_tweets(pages, include_rts)
